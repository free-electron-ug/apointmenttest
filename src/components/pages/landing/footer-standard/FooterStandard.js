...
const FooterStandard = () => {
  ...
  return (
    <>
      <Section className="pt-8 pb-4 light">
        ...
        <Row>
          <Col lg={4}>
            ...
            <p className="text-600 text-justify">{I18n.get('lead1')}</p>
            <p className="text-600 text-justify">{I18n.get('lead2')}</p>
            <p className="text-600 text-justify">{I18n.get('lead3')}</p>
      ...
      <section className="py-0 text-center fs--1 light">
