...
import defaultModeImg from 'assets/img/free-electron/Light.png';
import darkModeImg from 'assets/img/free-electron/Dark.png';
        ...
        <Flex>
          ...
          <div>
            ...
            <p className="fs--1 mb-2">
              Set a language for your web application....................
            </p>
            <Form.Select
              className="mb-3"
              size="sm"
              ...
              onChange={({ target }) => {
                setConfig('language', target.value);
            ...
            >
              {['de', 'en'].map(option => (
                <option
                  key={option}
                  disabled={disabledLanguage.includes(option)}
                  value={option}
                >
